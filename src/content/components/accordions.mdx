...
order: 8
type: "Building"
description: "Documentation and examples for accordions in ravixUI"
tags: ["accordion", "accordion-examples","ravixUI","AstroJS"]
keywords: "accordion, web component, ravixUI, AstroJS, TailwindCSS"
---
...
<Code code={NormalAccordionCode} lang="html" wrap="true" data-pagefind-ignore />
    ...
    <WebComponentAccordion
      panels={[
        ...
        },
        {
          ...
          content:
            "Instead of searching the whole page using document.querySelector(), you can use this.querySelector(), which only searches within the current custom element instance. This makes it easier to work with only the children of one component instance at a time. It also removes the need to attach event listeners to the document and allows for better encapsulation of the component's functionality.",
        },

        {
          header: "What benefits does Web Components offer?",
          content:
            "Web Components allow you to create reusable custom elements which can be used multiple times throughout your application. They also allow you to attach and detach elements from the DOM based on the state of your application, making it a cleaner and more efficient way to build your web pages.",
        },
      ]}
    />
