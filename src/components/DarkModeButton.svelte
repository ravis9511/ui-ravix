...
<button
  class="flex items-center justify-start rounded-full p-3 text-center text-base text-indigo-800 hover:bg-gray-200 lg:items-start dark:text-yellow-400 dark:hover:bg-zinc-800"
