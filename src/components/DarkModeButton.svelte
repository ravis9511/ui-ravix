...
<button
  class="flex rounded-full text-base px-2 lg:px-5 py-2 text-center items-center lg:items-start justify-start dark:text-yellow-400 text-indigo-800 hover:bg-gray-200 dark:hover:bg-zinc-800"
...
>
  ...
  <span class="block text-lg lg:hidden ml-2" aria-hidden="true"
    >{darkMode ? "Light" : "Dark"} mode</span
  >
</button>
