...
<TableWrapper>
  ...
  ----------------------- | ---- | ---------------- | ---- | --- |
  ---------------- | | Simple Alerts | Yes | Yes | Yes | Yes | Yes | | Alternate
  Simple Alerts | Yes | Yes | Yes | Yes | Yes | | Alerts with Icons | Yes | Yes
  | Yes | Yes | Yes | | Prominent Alerts | Yes | Yes | Yes | Yes | Yes | |
