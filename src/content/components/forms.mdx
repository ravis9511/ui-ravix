...
order: 15
type: "Building"
description: "Documentation and examples for forms in ravixUI"
tags: ["forms", "form-examples","ravixUI","WCAG 2.1","WAI-ARIA 1.2"]
keywords: "forms, ravixUI, AstroJS, TailwindCSS"
---
...
<Code
  code={SelectCodeAstro}
  lang="astro"
  title="SelectVariants.astro"
  wrap="true"
  data-pagefind-ignore
/>
...
<Code
  code={CheckboxCodeAstro}
  lang="astro"
  title="CheckboxVariants.astro"
  wrap="true"
  data-pagefind-ignore
/>
