...
<Accordion
    data={[
        ...
        {   name : "breadcrumb1",
            ...
            content:
                "The nav element should be used for the breadcrumbs with aria-label attribute set to Breadcrumbs. The current page link should be at the end of the breadcrumbs with the attribute aria-current set to page.",
        }
    ]}
/>
