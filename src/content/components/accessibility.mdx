...
order: 2
type: "Introduction"
description: "Documentation for the accessibility features and tools used in ravixUI"
tags: ["accessibility", "accessibility-tools","ravixUI","WCAG 2.1","WAI-ARIA 1.2"]
keywords: "accessibility, accessibility-tools, ravixUI, AstroJS"
---
