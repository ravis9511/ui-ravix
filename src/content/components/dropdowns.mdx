...
<Accordion
 data={[
    ...
    },
    {
      ...
      content:
        "The component in ravixUI follows the accessibility patterns guidelines provided by WAI-ARIA APG specification for menubutton and menu and follow WAI-ARIA 1.2. Dropdown is different from input select because it is not a form element.",
    },
  ]}
/>
...
<Dropdown menuLabel={menuLabel} menuItems={menuItems} />
