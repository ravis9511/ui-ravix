...
<Accordion
  data={[
    ...
    {
      name: "accordion1",
      title: "Accessbility Considerations",
      content:
        "For the first accordion in the components below, we use the semantic HTML tag details for implementation and hence it is accessible out of the box. But for the other accordions, ravixUI uses a combination of aria-controls, aria-expanded, aria-labelledby , aria-hidden, and roles like button and region to make it accessible.",
    },
  ]}
/>
...
A simple accordion capable of containing numerous accordion items. No supplementary JavaScript is necessary. The implementation utilizes the widely browser-supported details tag.

**Note:** The autoclose others when open accordions is not supported for `details` tag in Firefox at this moment. To check compatibility of the `details` tag in different browsers, you can check [this link which leads to caniuse.com/details](https://caniuse.com/details).
...
<section id ="AL-Tab2-panel" role="tabpanel" data-role="tabpanel" aria-labelledby="AL-Tab2">
...
<section id ="AL-Tab3-panel" role="tabpanel" data-role="tabpanel" aria-labelledby="AL-Tab3">
...
The animated accordion is available as a web component in ravixUI. You can find the implementation and code below.
...
<section id ="WC-Tab3-panel" role="tabpanel" data-role="tabpanel" aria-labelledby="WC-Tab3">
...
| ---------------------------- | -------------- | ----------------- |
| Accordion                    | Yes            | No                |
| Animated Accordion           | Yes            | No                |
| Alternate Animated Accordion | Yes            | No                |
| Web Component Accordion      | Yes            | No                |

Check the ravixUI roadmap for more details about automated testing.
