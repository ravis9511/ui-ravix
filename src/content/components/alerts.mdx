...
order: 9
type: "Building"
description: "Documentation and examples for alerts in ravixUI"
tags: ["alerts", "alerts-examples","ravixUI","WCAG 2.1","WAI-ARIA 1.2"]
keywords: "alerts, ravixUI, AstroJS,TailwindCSS"
---
...
<Code code={AltAlertsCode} lang="html" wrap="true" data-pagefind-ignore />
...
<Code code={AlertsCode} lang="html" wrap="true" data-pagefind-ignore />
...
<Code code={AlertsWithIconCode} lang="html" wrap="true" data-pagefind-ignore />
...
<Code code={ProminentAlertsCode} lang="html" wrap="true" data-pagefind-ignore />
...
The alerts adhere to the [WAI-ARIA 1.2 specification
](https://www.w3.org/WAI/ARIA/apg/patterns/alert/examples/alert/) for alert
patterns.
