...
The contrast between the text and the background is important for readability. The easiest way to ensure contrast is to go with pairs like ```bg-gray-50 text-zinc-950``` for light mode and ```dark:bg-zinc-950 dark:text-gray-50``` for dark mode for paragraphs. 
