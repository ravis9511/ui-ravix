...
order: 27
type: "Navigation"
description: "Documentation and examples for tabs in ravixUI"
tags: ["tabs", "tabs-examples","ravixUI","Astrojs"]
keywords: "tabs, web component, ravixUI, AstroJS, TailwindCSS"
---
...
| -------------------------- | ---- | ---------------- | ---- | --- | ---------------- |
| Normal Tabs                | Yes  | Yes              | Yes  | Yes | Yes              |
| Normal Tabs With Icons     | Yes  | Yes              | Yes  | Yes | Yes              |
| Gradient Tabs With Icons   | Yes  | Yes              | Yes  | Yes | Yes              |
| Astrojs Web Component Tabs | Yes  | Yes              | Yes  | Yes | Yes              |
