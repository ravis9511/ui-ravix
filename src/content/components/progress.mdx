...
For knowing more about the progressbar role used in the examples above, [you can
read the w3c WAI-ARIA 1.3 documentation about progressbar
role](https://w3c.github.io/aria/#progressbar)
