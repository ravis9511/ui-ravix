...
<Code code={SimpleCardCode} lang="html" wrap="true" data-pagefind-ignore />
...
<Code code={HorizontalCardCode} lang="html" wrap="true" data-pagefind-ignore />
...
<Code code={FeaturesCardCode} lang="html" wrap="true" data-pagefind-ignore />
...
<Code code={GradientCardCode} lang="html" wrap="true" data-pagefind-ignore />
...
<Code code={GlassCardCode} lang="html" wrap="true" data-pagefind-ignore />
...
<TableWrapper>
  ...
  --------------- | ---- | ---------------- | ---- | --- | ---------------- | |
  Simple Card | Yes | Yes | Yes | Yes | Yes | | Horizontal Card | Yes | Yes |
  Yes | Yes | Yes | | Features Card | Yes | Yes | Yes | Yes | Yes | | Gradient
  Card | Yes | Yes | Yes | Yes | Yes | | Glass Card | Yes | Yes | Yes | Yes |
  Yes |
</TableWrapper>
There are no clear accessibility guidelines for the cards pattern described by
WAI-ARIA, so ravixUI implements basic accessbility patterns applicable to all
elements present inside the cards while adhering to the WCAG 2.1 AA standard.
