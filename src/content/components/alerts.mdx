...
Colors are added to provide more context to the alert message, but it is important to add textual messages which convey the same information. Note that ravixUI is opinionated on semantic coloring, hence green, yellow and red are reserved for success, warning and error respectively.

To know more about the aria role alert you can refer to [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Roles/alert_role).
...
<section id ="AA-Tab2-panel" role="tabpanel" data-role="tabpanel" aria-labelledby="AA-Tab2">
...
<section id ="AA-Tab3-panel" role="tabpanel" data-role="tabpanel" aria-labelledby="AA-Tab3">
...
<section id ="AWI-Tab3-panel" role="tabpanel" data-role="tabpanel" aria-labelledby="AWI-Tab3">
...
<section id ="PA-Tab2-panel" role="tabpanel" data-role="tabpanel" aria-labelledby="PA-Tab2">
...
<section id ="PA-Tab3-panel" role="tabpanel" data-role="tabpanel" aria-labelledby="PA-Tab3">
...
<section id ="AC-Tab3-panel" role="tabpanel" data-role="tabpanel" aria-labelledby="AC-Tab3">
