...
- ViewTransition for attaching event listeners to the viewport if the component uses JavaScript. For more information on ViewTransition, please refer to the [AstroJS guide on View Transitions](https://docs.astro.build/en/guides/view-transitions/).
