...
The component generates a 16 character unique id for the dropdown button and menu using the `randomUUID()` function from the crypto module. If crypto is not supported, an alternative unique ID generation method is provided. For checking browser compatibility of crypto module, you can check [this link which leads to caniuse.com/crypto](https://caniuse.com/crypto).
